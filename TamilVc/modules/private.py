...
def map(pos):
    if(pos==1):
        ...
        button = [
            ...
            [InlineKeyboardButton(text = '📲 Kanal', url=f"https://t.me/ledyplaylist"),
             InlineKeyboardButton(text = '🛠️ Dəstək', url=f"https://t.me/SOQrup")],
            [InlineKeyboardButton(text = '😈 Owner', url=f"https://t.me/Tenha055")],
